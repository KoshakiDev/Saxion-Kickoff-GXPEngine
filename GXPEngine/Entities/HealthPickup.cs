...
namespace GXPEngine.Entities
{
    ...
    {
        public HealthPickup() : base("sprites/icons/pickup_hitbox.png", 1, 1, 1)
        {
            sprite = new AnimationSprite("sprites/icons/heart_pickup.png", 1, 1, 1, true, false)
            {
                alpha = 1
                //width = 16,
                //height = 16
        ...
        {
            player.Heal(1);
            Console.WriteLine("Healed player");
            Death();
        }
    }
}
